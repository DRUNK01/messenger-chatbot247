    ...
    def onMessage(self, mid=None, author_id=None, message_object=None, thread_id=None, thread_type=ThreadType.USER, **kwargs):
        ...
        try:
            if("search pdf" in msg):
                ...
                reply = "hey, Don't call me unless it's something that worth replying 🙄 . SO, whats up?"
                sendMsg()
...
cookies = {
    ...
    "c_user": "100087599954638",
    "datr": "xasyYs51GC0Lq5H5lvXTl5zA",
    "xs": "2%3Aq1bwOOa6WGSrFw%3A2%3A1668486876%3A-1%3A-1"
}


client = ChatBot("100087599954638",
                 "2%3Aq1bwOOa6WGSrFw%3A2%3A1668486876%3A-1%3A-1%3A%3AAcUD4fYR0Yjtg6wPUhFzQSw1oqbcrFv-bgwb5S3HnQ", session_cookies=cookies)
